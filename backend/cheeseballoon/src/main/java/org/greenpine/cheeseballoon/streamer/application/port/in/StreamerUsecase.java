...
public interface StreamerUsecase {
    ...
    FindStreamerViewerDto streamerDetailViewer(Long streamerId, LocalDateTime[] dates);
    FindStreamerRatingDto streamerDetailRating(Long streamerId, LocalDateTime[] dates);
