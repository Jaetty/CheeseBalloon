...
public class LiveService implements LiveUsecase, CategoryUsecase {
    ...
    public List<FindBarchartData> findBarchartData() {
        ...
        ret.add(FindBarchartData.builder().Date(startDate.plusDays(13).format(DateTimeFormatter.ofPattern("MM/dd"))).dataList(livePort.findBarchartData(currDt,startDate.plusDays(13).toString()+"-0")).build());
